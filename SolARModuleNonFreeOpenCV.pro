...
include ($${QMAKE_REMAKEN_RULES_ROOT}/templatelibconfig.pri)  # Shell_quote & shell_path required for visual on windows
...
include ($${QMAKE_REMAKEN_RULES_ROOT}/remaken_install_target.pri) # Shell_quote & shell_path required for visual on windows
